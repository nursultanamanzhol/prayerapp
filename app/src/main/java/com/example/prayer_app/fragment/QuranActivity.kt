...
lateinit var recyclerView: RecyclerView
    ...
    override fun onCreateView(
        ...
        binding = FragmentQuranActivityBinding.inflate(layoutInflater)
        initial()
        return  binding.root
    ...
    fun myUser(): ArrayList<UserModel>{
        ...
        val user = UserModel("Фатиха сүресі", "Ә’узу биллаһи минаш-шайтанир-ражим \n" +
        ...
        userList.add(user)
        val user1 = UserModel("Асыр сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
                "«Уәл’аср, иннәл инсәәнә ләфи хуср, илләлләзинә әәмәну уа амилус-саалихати уа тауасау билхаққи уа тауаасау биссабр»")
        userList.add(user1)
        val user2 = UserModel("Фил сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
        ...
        userList.add(user2)
        val user3 = UserModel("Кәусәр сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
                "«Иннәә ә’тайнакәл кәусәр, фасалли лираббика уәнхар, инна шәниәкә һуәл әбтәр»")
        userList.add(user3)
        val user4 = UserModel("Ықылас сүресі", "Бисмилләәһир-рахмаанир-рахим\n" +
                "«Қул һуаллаһу ахад, Аллаһус-самад, ләм иәлид уә ләм иуләд, уә ләм иәкул-ләһу куфуан ахад»")
        userList.add(user4)
        val user5 = UserModel("Фалақ сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
        ...
        userList.add(user5)
        val user6 = UserModel("Нас сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
        ...
        val user7 = UserModel("Аятул-Күрсі", "Бисмилләәһир-рахмаанир-рахиим\n" +
        ...
        val user8 = UserModel("Кафирун сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
        ...
        val user9 = UserModel("Насыр сүресі", "Бисмилләәһир-рахмаанир-рахиим\n" +
